...
Generates game summary reports (PDF, DOCX, TXT)
Logs all interactions in a Process Mining CSV event log
Includes JUnit tests, Maven build, and GitHub documentation
✔ Software Engineering Requirements
Applies ≥3 design patterns (Factory, Strategy, Observer, Command, Singleton)
Applies all SOLID principles
Packaged using Maven
Includes demo and reflection videos
